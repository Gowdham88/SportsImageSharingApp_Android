...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            updateLikesCounter(holder, holder.getPostItem().getLikecount());
    ...
    private void animateHeartButton(final FeedAdapter.CellFeedViewHolder holder) {
        ...
        bounceAnimY.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                if ( holder.getPostItem().getUserlikes().size() > 0) {

                    if ( holder.getPostItem().getUserlikes().get(PreferencesHelper.getPreference( holder.context,PreferencesHelper.PREFERENCE_FIREBASE_UUID)) != null){

                        Boolean isLiked =  holder.getPostItem().getUserlikes().get(PreferencesHelper.getPreference(holder.context,PreferencesHelper.PREFERENCE_FIREBASE_UUID));
