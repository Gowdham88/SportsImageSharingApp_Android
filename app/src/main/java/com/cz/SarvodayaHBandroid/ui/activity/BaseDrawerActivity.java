...
public class BaseDrawerActivity extends BaseActivity {
    ...
    @BindDimen(com.cz.SarvodayaHBandroid.R.dimen.global_menu_avatar_size)
    int avatarSize;
    @BindString(com.cz.SarvodayaHBandroid.R.string.user_profile_photo)
    String profilePhoto;
    ...
    public void setContentView(int layoutResID) {
        super.setContentViewWithoutInject(com.cz.SarvodayaHBandroid.R.layout.activity_drawer);
        ViewGroup viewGroup = (ViewGroup) findViewById(com.cz.SarvodayaHBandroid.R.id.flContentRoot);
