    ...
    private void animateHeartButton(final FeedAdapter.CellFeedViewHolder holder) {
        ...
        bounceAnimY.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                if ( holder.getPostItem().getLikes().size() > 0) {

                    if ( holder.getPostItem().getLikes().get(PreferencesHelper.getPreference( holder.context, PreferencesHelper.PREFERENCE_FIREBASE_UUID)) != null){

                        Boolean isLiked =  holder.getPostItem().getLikes().get(PreferencesHelper.getPreference(holder.context, PreferencesHelper.PREFERENCE_FIREBASE_UUID));
